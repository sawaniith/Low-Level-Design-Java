...
public class ConcertMain {
    public static void main(String[] args) {
        ...
        Concert concert1 = new Concert("C001", "Artist 1", "Venue 1", LocalDate.now().plusDays(30), concert1Seats);
        bookingSystem.addConcert(concert1);

        List<Seat> concert2Seats = generateSeats(50);
        Concert concert2 = new Concert("C002", "Artist 2", "Venue 2", LocalDate.now().plusDays(60), concert2Seats);
        ...
        // Search concerts
        List<Concert> searchResults = bookingSystem.searchConcerts("Artist 1", "Venue 1", LocalDate.now().plusDays(30));
