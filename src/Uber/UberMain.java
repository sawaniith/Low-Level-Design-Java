...
import Uber.Payments.CreditCardPayment;

public class UberMain {
    public static void main(String[] args) {
        UberService rideSharingService = UberService.getInstance();
        ...
        Trip trip2 = rideSharingService.requestRide(user2.getId(), new Location(37.7749, -102.6124), new Location(37.7749, -122.4194));
