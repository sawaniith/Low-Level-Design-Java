...
public class StackOverflowMain {
    public static void main(String[] args) {
        ...
        system.addQuestionComment(charlie, javaQuestion, "Great question! I'm also interested in learning about this.");

        // Alice comments on Bob's answer
        system.addAnswerComment(alice, bobAnswer, "Thanks for the explanation! Could you provide a code example?");
